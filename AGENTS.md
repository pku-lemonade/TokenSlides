...
- `theme/base.typ`: global knobs (`layout-config` = per-aspect font sizes/spacing/margins/page size, `font-config`, `accent-config`, `mode-config`) + runtime state (`cur-ar`, `cur-colors`, `cur-box`)
