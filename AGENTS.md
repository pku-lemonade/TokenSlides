...
- `examples/`: complete sample decks by genre, one folder per deck: `examples/<genre>/<deck>/<deck>.typ` with figures in `assets/`; only sources and assets are tracked. Decks use only the public API
