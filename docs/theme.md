# Writing a deck with the Lemonade theme

How a deck file uses the theme: the scaffold, rows and figures, and code
listings. The compilable reference for each module is the deck beside this
page (`docs/<module>.typ`); AGENTS.md holds the conventions an agent follows.
