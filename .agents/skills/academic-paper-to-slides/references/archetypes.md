...
- For generated lecture visuals, keep one or two dominant panels with short captions; do not turn the image into a dense poster.
...
- Do not leave the left column blank. Provide boxes or bullets, or let the takeaway render as the fallback support line.
...
- Generated companion panels are acceptable when they are planned from the same visual intent and stay visually consistent.
...
- For generated method cards, keep the cards visually parallel and avoid putting long explanations inside the images.
...
- Generated comparison panels should share a visual grammar so the comparison is about the concept, not stylistic differences.
